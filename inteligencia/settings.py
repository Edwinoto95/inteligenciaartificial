"""
Django settings for inteligencia project.
...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-*#ka6hlmtn&07hnm_n!5_n3i*hhae@=5nhxllmyz3nk=qf^13z')
...
ROOT_URLCONF = 'inteligencia.urls'
...
WSGI_APPLICATION = 'inteligencia.wsgi.application'
...
if DATABASE_URL:
    ...
    # El formato es: postgres://usuario:contraseña@host:puerto/nombre_db
    db_parts = DATABASE_URL.split('://')[-1].split(':')
    user_pass = db_parts[0]
    ...
    db_name = host_port_name[1] if len(host_port_name) > 1 else ''
...
STATIC_URL = 'static/'
STATICFILES_DIRS = (os.path.join(BASE_DIR, 'inteligencia/static'),)
